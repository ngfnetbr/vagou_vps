...
ADD COLUMN IF NOT EXISTS habilitar_sam boolean DEFAULT true;

ALTER TABLE public.configuracoes_sistema
ADD COLUMN IF NOT EXISTS habilitar_sondagem boolean DEFAULT true;

UPDATE public.configuracoes_sistema
SET habilitar_sam = true
WHERE habilitar_sam IS NULL;

UPDATE public.configuracoes_sistema
SET habilitar_sondagem = true
WHERE habilitar_sondagem IS NULL;
