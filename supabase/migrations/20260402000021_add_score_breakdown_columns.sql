...
ADD COLUMN IF NOT EXISTS pontos_prioridades integer NULL,
ADD COLUMN IF NOT EXISTS pontos_programas_sociais integer NULL,
ADD COLUMN IF NOT EXISTS pontos_remanejamento integer NULL,
ADD COLUMN IF NOT EXISTS pontos_data_cadastro integer NULL,
ADD COLUMN IF NOT EXISTS bonus_zona_cmei1 integer NULL,
ADD COLUMN IF NOT EXISTS bonus_zona_cmei2 integer NULL,
ADD COLUMN IF NOT EXISTS bonus_zona_cmei3 integer NULL;
