...
ADD COLUMN IF NOT EXISTS cor_raca_autodeclarada text,
ADD COLUMN IF NOT EXISTS cor_raca_certidao text,
ADD COLUMN IF NOT EXISTS etnia_indigena text,
ADD COLUMN IF NOT EXISTS etnia_indigena_outra text,
ADD COLUMN IF NOT EXISTS quilombo_remanescente boolean,
ADD COLUMN IF NOT EXISTS quilombo_nome text,
ADD COLUMN IF NOT EXISTS nacionalidade text,
ADD COLUMN IF NOT EXISTS estrangeiro_possui_documentos boolean,
ADD COLUMN IF NOT EXISTS nis text,
ADD COLUMN IF NOT EXISTS unidade_consumidora text,
ADD COLUMN IF NOT EXISTS forma_ocupacao_moradia text,
ADD COLUMN IF NOT EXISTS forma_ocupacao_moradia_outro text,
ADD COLUMN IF NOT EXISTS responsavel_rg text,
ADD COLUMN IF NOT EXISTS responsavel_telefone_comercial text,
ADD COLUMN IF NOT EXISTS filiacao1_nome text,
ADD COLUMN IF NOT EXISTS filiacao1_rg text,
ADD COLUMN IF NOT EXISTS filiacao1_cpf text,
ADD COLUMN IF NOT EXISTS filiacao1_email text,
ADD COLUMN IF NOT EXISTS filiacao1_celular text,
ADD COLUMN IF NOT EXISTS filiacao1_telefone_comercial text,
ADD COLUMN IF NOT EXISTS filiacao2_nome text,
ADD COLUMN IF NOT EXISTS filiacao2_rg text,
ADD COLUMN IF NOT EXISTS filiacao2_cpf text,
ADD COLUMN IF NOT EXISTS filiacao2_email text,
ADD COLUMN IF NOT EXISTS filiacao2_celular text,
ADD COLUMN IF NOT EXISTS filiacao2_telefone_comercial text;

DROP FUNCTION IF EXISTS public.inserir_inscricao_publica(
  text, date, text, text, text, text, text, text, text, text,
  text, text, text, text, text, text, text, uuid, uuid, boolean, boolean, text, uuid, uuid, uuid, text
);
