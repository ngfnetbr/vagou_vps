...
ADD COLUMN IF NOT EXISTS tema_sidebar_gradiente_ativo boolean DEFAULT false;

ALTER TABLE public.configuracoes_sistema
ADD COLUMN IF NOT EXISTS tema_sidebar_gradiente_inicio text;

ALTER TABLE public.configuracoes_sistema
ADD COLUMN IF NOT EXISTS tema_sidebar_gradiente_fim text;

UPDATE public.configuracoes_sistema
SET tema_sidebar_gradiente_ativo = false
WHERE tema_sidebar_gradiente_ativo IS NULL;
