...
- **Implementação:**
    ...
    - `scripts/deploy/backup.ps1`: Criado script PowerShell para facilitar o backup manual do banco de dados no ambiente Windows.
    - `scripts/verify/test-api.js`: Criado script para verificação de conectividade com a API Supabase.
