...
echo "   - scripts/01-setup-estrutura.sql"
echo "   - scripts/02-setup-storage.sql"
echo "   - scripts/03-setup-dados-iniciais.sql"
echo "   - scripts/04-setup-automacao.sql (opcional)"
echo ""
